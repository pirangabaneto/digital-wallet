<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="cpf" class="block mt-1 w-full" type="text" name="cpf" :value="old('cpf')" required autofocus autocomplete="cpf" placeholder="000.000.000-00" />
        ...
        <div class="w-full text-center mt-8">
            <p>
                Already registered?
                <a href="{{ route('login') }}" class="text-[#F8AD15] underline font-bold">Log In</a>
            </p>
        </div>
    </form>
</x-guest-layout>
